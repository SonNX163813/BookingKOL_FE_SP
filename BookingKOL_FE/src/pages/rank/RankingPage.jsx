...
import { Search, CalendarToday, Category, Sort, GridView, ViewList } from "@mui/icons-material";
...
export const data = [
    { rank: 1, name: "Quang Vinh", category: "Công Nghệ", followers: "5.2M", engagement: "8.5%", growth: "+15%" },
    { rank: 2, name: "Linh Chi", category: "Làm Đẹp", followers: "2.1M", engagement: "12.3%", growth: "+22%" },
    { rank: 3, name: "Mai Anh", category: "Lifestyle", followers: "1.8M", engagement: "9.7%", growth: "+8%" },
    { rank: 4, name: "Đức Phúc", category: "Công Nghệ", followers: "1.5M", engagement: "7.2%", growth: "+12%" },
    { rank: 5, name: "Thúy Kiều", category: "Làm Đẹp", followers: "1.3M", engagement: "11.8%", growth: "+18%" },
];
            ...
            <div className="max-w-[1500px] mx-auto">
                ...
                <div className="text-center mb-10">
                    <h1 className="text-4xl font-extrabold flex items-center justify-center gap-3">
                        <Trophy className="w-8 h-8 text-yellow-400" strokeWidth={2.5} /> KOL Ranking Pro
                    </h1>
                ...
                <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 mb-12 shadow-2xl">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                        ...
                        <div>
                            ...
                            <FormControl fullWidth sx={{ background: "white", borderRadius: "8px", mt: 2 }}>
                        ...
                        <div>
                            ...
                            <div className="flex flex-wrap gap-2">
                                {["Tất cả", "Làm đẹp", "Lifestyle", "Công nghệ"].map((cat, i) => (
                                    <button
                                        key={i}
                        ...
                        <div>
                            ...
                            <div className="flex gap-3">
                                <IconButton
                                    ...
                                    sx={{ background: view === "grid" ? "linear-gradient(to right,#6a11cb,#2575fc)" : "white" }}
                                >
                                    <GridView />
                                </IconButton>
                                <IconButton
                                    onClick={() => setView("list")}
                                    sx={{ background: view === "list" ? "linear-gradient(to right,#6a11cb,#2575fc)" : "white" }}
                                >
                                    <ViewList />
                                </IconButton>
                            </div>
                    ...
                    <div className="mt-10 flex justify-center gap-6 items-end">
                        {top3.map((kol, index) => (
                            ...
                            >
                                ...
                                <div className="absolute -top-4 left-1/2 transform -translate-x-1/2 bg-white shadow-md px-3 py-1 
                                ...
                                <div className="bg-white text-black font-bold text-xl py-3 rounded-lg mt-4 shadow-inner">
                                    {kol.followers} <span className="text-sm font-normal">Followers</span>
                                </div>
                ...
                {view === "list" ? <RankingList data={data} /> : <RankingGrid data={data} />}
            </div>
        </div>
    );
};
