...
const ChatAIPage = () => {
    ...
    return (
        <div className="h-[calc(100vh-100px)] flex flex-col bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white">
            ...
            <div className="flex-1 w-full max-w-[1500px] mx-auto px-4 py-5 flex gap-4 h-full min-h-0">  {/* 👈 thêm h-full min-h-0 */}

                <div className="w-1/4 bg-gray-800 rounded-lg p-4 text-center overflow-auto"> {/* optional: overflow-auto nếu banner dài */}
                ...
                <div className="flex-1 flex flex-col bg-gray-900 rounded-lg border border-gray-700 overflow-hidden min-h-0">
                    ...
                    <div className="w-full border-t border-gray-700 p-3 shrink-0">  {/* 👈 shrink-0 */}
                        <Form
                            form={form}
                            onFinish={onFinish}
                            className="w-full"
                        ...
                        >
                            <Form.Item name="question" style={{ flex: 1, marginBottom: 0, marginLeft: 10 }}>
                                <Input
